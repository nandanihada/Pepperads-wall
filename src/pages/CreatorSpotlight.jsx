        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center p-4">
          ...
          <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-12 w-full max-w-4xl text-center shadow-2xl">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Curated creator insights from across the web â€” shared here for inspiration. Credit to original sources.
            </p>
          </div>
        </div>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                ...
                <div className="backdrop-blur-md bg-black/30 rounded-xl p-6">
                  ...
                  <p className="text-gray-300">
                    â€œWe utilized Pepperwahlâ€™ gamified surveys alongside performance-based incentives to engage users at scale. This approach not only delivered high-quality insights but also improved user retention across key audience segments.â€
                  </p>
                </div>
