    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-200 sticky top-[56px] sm:top-[64px] z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 mt-2" style={{ fontFamily: "'Outfit', 'Inter', sans-serif" }}>Privacy Policy</h1>
          <p className="text-xs sm:text-sm text-stone-500 mt-1">Effective date: July 18, 2026 &nbsp;|&nbsp; Last updated: July 19, 2026 &nbsp;|&nbsp; Version: 1.5</p>
        </div>
      </div>

      <div className="max-w-7xl mx-auto flex gap-0">
        {/* Sidebar */}
        <aside className="hidden lg:block w-56 shrink-0 sticky top-[190px] h-[calc(100vh-190px)] overflow-y-auto py-8 pl-6 pr-4">
        ...
        {/* Main Content */}
        <main className="flex-1 py-6 sm:py-8 px-4 sm:px-6 lg:px-12">
          <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 sm:p-10 lg:p-16">

            <section id="scope" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">1. Scope & Applicability</h2>
            ...
            <section id="definitions" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">2. Definitions</h2>
            ...
            <section id="data-collect" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">3. Data We Collect</h2>
              ...
              <div className="overflow-x-auto rounded-lg border border-stone-200 mb-6">
                <table className="w-full text-[13px]">
                  ...
                  <tbody className="text-stone-600">
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Usage Data</td><td className="p-3">Pages visited, features used, clicks, session duration</td></tr>
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Device & Browser Data</td><td className="p-3">IP address, browser type, operating system, device type</td></tr>
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Inferred Location</td><td className="p-3">Approximate geographic location from IP address only</td></tr>
            ...
            <section id="how-use" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">4. How We Use Your Data</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[14px] text-stone-600 leading-relaxed mb-6">
                ...
                <li>Prevent duplicate responses</li>
                <li>Improve survey delivery and user experience</li>
              </ul>
            ...
            <section id="legal-basis" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">5. Legal Basis for Processing</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
                  ...
                  <tbody className="text-stone-600">
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Consent</td><td className="p-3">Marketing emails, non-essential cookies, optional AI features</td><td className="p-3">Withdraw anytime</td></tr>
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Contract</td><td className="p-3">Account management, billing, service delivery</td><td className="p-3">Necessary for service</td></tr>
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Legitimate Interest</td><td className="p-3">Product improvement, fraud prevention, analytics</td><td className="p-3">Object via email</td></tr>
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Legal Obligation</td><td className="p-3">Subpoenas, tax records, regulatory compliance</td><td className="p-3">Required by law</td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section id="cookies" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">6. Cookies & Tracking Technologies</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
                  ...
                  <tbody className="text-stone-600">
                    ...
                    <tr className="border-t border-stone-100"><td className="p-3 font-mono text-xs">_pw_analytics</td><td className="p-3">Page views, feature usage</td><td className="p-3">2 years</td><td className="p-3"><span className="text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded text-[11px]">Required</span></td></tr>
                  </tbody>
                </table>
              </div>
            </section>
            ...
            <section id="data-sharing" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">7. Data Sharing & Disclosure</h2>
            ...
            <section id="subprocessors" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">8. Subprocessors</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
            ...
            <section id="retention" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">9. Data Retention</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
            ...
            <section id="transfers" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">10. International Data Transfers</h2>
            ...
            <section id="rights-global" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">11. Your Rights - Global Overview</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
                  ...
                  <tbody className="text-stone-600">
                    ...
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium text-stone-800">Portability</td><td className="p-3">Export data in machine-readable format</td><td className="p-3">Built-in export tools</td></tr>
            ...
            <section id="india-dpdp" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">12. India - DPDP Act, 2023</h2>
            ...
            <section id="eu-gdpr" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">13. EU/UK - GDPR</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed">Additional rights for EU/UK individuals: restrict processing, object to processing, right not to be subject to automated decision-making, lodge a complaint with your supervisory authority. International transfers use Standard Contractual Clauses (SCCs).</p>
            </section>

            <section id="us-ccpa" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">14. US - CCPA/CPRA</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed">We do not sell personal information as defined by the CCPA. California residents can opt out of "sharing" via our "Do Not Sell or Share" link. Rights include: right to know, delete, correct, opt-out, and non-discrimination.</p>
            </section>

            <section id="brazil-lgpd" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">15. Brazil - LGPD</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed">Rights include: access, correction, anonymization, blocking, deletion, portability, information about sharing, and revocation of consent. DPO: privacy@pepperwahl.com</p>
            </section>

            <section id="other-regions" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">16. Other Regions</h2>
              ...
              <p className="text-[14px] text-stone-600 leading-relaxed"><strong>Australia (Privacy Act 1988):</strong> Access, correction, and complaint rights via OAIC.</p>
            </section>

            <section id="children" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">17. Children's Data</h2>
            ...
            <section id="security" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">18. Security</h2>
              <div className="overflow-x-auto rounded-lg border border-stone-200">
                <table className="w-full text-[13px]">
                  ...
                  <tbody className="text-stone-600">
                    ...
                    <tr className="border-t border-stone-100"><td className="p-3 font-medium">Access controls</td><td className="p-3">Role-based with least-privilege</td></tr>
            ...
            <section id="research" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">19. Research Privacy Notice</h2>
            ...
            <section id="acceptable-use" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">20. Acceptable Use & Creator Responsibilities</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed">Creators must comply with all applicable data protection laws, provide clear disclosures to respondents, obtain appropriate consent, and not use the Services for spam, fraud, harassment, or discrimination.</p>
            </section>

            <section id="changes" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">21. Changes to This Policy</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed">We notify all account holders by email at least 30 days before material changes take effect. Continued use after changes constitutes acceptance.</p>
            </section>

            <section id="contact" className="mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">22. Contact Us</h2>
