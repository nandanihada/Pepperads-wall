...
const CommunityShowcases = () => {
  ...
  const showcases = [
    ...
    },
    {
      ...
      description: "Creator | A streamerâ€™s setup that unlocked $12K in new revenue.",
      ...
      <div style={styles.container}>
          ...
          <div style={styles.featuredGrid}>
            <div style={styles.featuredContent}>
              ...
              <p style={styles.featuredText}>
                Fashion-tech creator Mia Chen scaled from 50K to 500K subscribers and 4x'd her monthly incomeâ€”powered by smart Pepperwahl integration and a laser-focused strategy.
              </p>
        ...
        <div style={styles.submitSection}>
          ...
          <p style={styles.submitText}>
            Using Pepperwahl and seeing success? Weâ€™d love to feature you. Get spotlighted in front of our global creator and brand community.
          </p>
          <button 
