    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-200 sticky top-[56px] sm:top-[64px] z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 mt-2" style={{ fontFamily: "'Outfit','Inter',sans-serif" }}>Acceptable Uses Policy</h1>
        ...
        <main className="flex-1 py-6 sm:py-8 px-4 sm:px-6 lg:px-12">
          <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 sm:p-10 lg:p-16">
            ...
            <section id="about" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">1. About This Policy</h2>
              <p className="text-[14px] text-stone-600 leading-relaxed mb-3">This Acceptable Uses Policy ("AUP") governs how you may use the Pepperwahl platform and services. It is incorporated into and forms part of our <a href="/terms-of-use" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">Terms of Use</a>.</p>
            ...
            <section id="prohibited" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">2. Prohibited Content</h2>
            ...
            <section id="data-rules" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">3. Data Collection Rules</h2>
            ...
            <section id="platform" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">4. Platform Integrity</h2>
            ...
            <section id="ai-usage" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">5. AI Feature Usage</h2>
              <ul className="list-disc pl-6 space-y-2 text-[14px] text-stone-600">
            ...
            <section id="enforcement" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">6. Enforcement</h2>
            ...
            <section id="changes" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">7. Changes to This Policy</h2>
            ...
            <section id="contact" className="mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">8. Contact Us</h2>
