    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-200 sticky top-[56px] sm:top-[64px] z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 mt-2" style={{ fontFamily: "'Outfit', 'Inter', sans-serif" }}>Terms of Use</h1>
          <p className="text-xs sm:text-sm text-stone-500 mt-1">Effective date: July 18, 2026 &nbsp;|&nbsp; Last updated: July 19, 2026 &nbsp;|&nbsp; Version: 1.2</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex gap-0">
        ...
        <main className="flex-1 py-6 sm:py-8 px-4 sm:px-6 lg:px-12">
          <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 sm:p-10 lg:p-16">
            {/* Intro banner */}
            <div className="bg-stone-50 border border-stone-200 rounded-xl p-4 sm:p-6 mb-8 sm:mb-10">
              <p className="text-[14px] text-stone-700 font-medium mb-2">Survtit Market Research Survey LLP</p>
              <p className="text-[11px] sm:text-[12px] text-stone-500 leading-relaxed uppercase">Please read these Terms of Use carefully. They govern your access to and use of the Pepperwahl platform and include a limitation of liability, an indemnification obligation, and a dispute resolution clause.</p>
            </div>

            <section id="acceptance" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">1. Acceptance of These Terms</h2>
            ...
            <section id="description" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">2. Description of the Services</h2>
            ...
            <section id="eligibility" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">3. Eligibility & Age Requirements</h2>
            ...
            <section id="account" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">4. Account Registration & Security</h2>
            ...
            <section id="roles" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">5. Roles Under These Terms</h2>
            ...
            <section id="subscription" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">6. Subscription Plans, Fees & Payment</h2>
            ...
            <section id="creator" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">7. Creator Responsibilities</h2>
            ...
            <section id="acceptable" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">8. Acceptable Use</h2>
            ...
            <section id="dpa" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">9. Data Processing Agreement</h2>
            ...
            <section id="ai" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">10. AI-Powered Features</h2>
            ...
            <section id="ip" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">11. Intellectual Property</h2>
            ...
            <section id="thirdparty" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">12. Third-Party Integrations</h2>
            ...
            <section id="disclaimers" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">13. Disclaimers</h2>
            ...
            <section id="liability" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">14. Limitation of Liability & Indemnification</h2>
            ...
            <section id="termination" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">15. Suspension & Termination</h2>
            ...
            <section id="governing" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">16. Governing Law & Dispute Resolution</h2>
            ...
            <section id="changes" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">17. Changes to These Terms</h2>
            ...
            <section id="general" className="mb-12">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">18. General</h2>
            ...
            <section id="contact" className="mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-stone-900 mb-4 pb-3 border-b border-stone-100">19. Contact Us</h2>
