    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-white border-b border-stone-200 sticky top-[56px] sm:top-[64px] z-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 mt-2" style={{ fontFamily: "'Outfit','Inter',sans-serif" }}>Do Not Sell or Share My Personal Information</h1>
          <p className="text-xs sm:text-sm text-stone-500 mt-1">California Consumer Privacy Act (CCPA) / CPRA Compliance</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 sm:p-10">
          ...
          <div className="bg-stone-50 border border-stone-200 rounded-xl p-4 sm:p-6 mb-8">
          ...
          <div className="bg-white border-2 border-stone-200 rounded-xl p-4 sm:p-6 mb-6">
            ...
            <div className={`p-4 rounded-lg mb-4 ${optedOut ? 'bg-green-50 border border-green-200' : 'bg-amber-50 border border-amber-200'}`}>
              <p className={`text-sm font-medium ${optedOut ? 'text-green-800' : 'text-amber-800'}`}>
                {optedOut
                  ...
                  : 'You have NOT opted out. Your data may be shared for advertising purposes.'}
              </p>
            </div>
          ...
          <div className="text-[13px] text-stone-500 space-y-2">
            ...
            <p className="mt-4">We will not discriminate against you for exercising your privacy rights. For more details, see <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">Section 14 of our Privacy Policy</a>.</p>
          </div>
        </div>
      </div>
    </div>
